...
const navItems: NavItem[] = [
  ...
  { href: Routes.SETTINGS, label: "Settings", icon: Settings, roles: [Roles.SUPER_ADMIN] },
  ...
  { href: Routes.ANNOUNCEMENTS, label: "Announcements", icon: Megaphone, roles: [Roles.SUPER_ADMIN, Roles.DEPARTMENT_ADMIN, Roles.STUDENT] },
  { href: Routes.ACTIVITY, label: "Activity", icon: Activity, roles: [Roles.SUPER_ADMIN, Roles.DEPARTMENT_ADMIN, Roles.STUDENT] },
  { href: Routes.NOTIFICATIONS, label: "Notifications", icon: Bell, roles: [Roles.SUPER_ADMIN, Roles.DEPARTMENT_ADMIN, Roles.STUDENT] },
